    ...
    <div className="pt-16 pb-15">
      <div className="w-4/5 mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-16">
        ...
        >
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl mt-8 font-bold md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[3.9rem] text-grey-800">
            Discover The JDN Difference
          </h1>
        ...
        >
          ...
          <div className="mt-10 w-full">
            ...
            <div className="-mt-10">
              ...
              <p className="w-[90%] lg-w-[70%] text-base text-black text-opacity-60">
                Our tutors are not only knowledgeable but also deeply committed to understanding each student&apos;s learning style and adapting lessons to keep them engaged and motivated. This ensures that students receive the focused guidance and encouragement they need to excel.
              </p>
            </div>
          </div>
          <div className="mt-10 w-full">
            ...
            <div className="-mt-10">
              ...
              <p className="w-[90%] lg-w-[70%] text-base text-black text-opacity-60">
                At JDN Tuition, we believe that a supportive learning environment is essential for academic success. That&rsquo;s why we foster a culture of encouragement, positivity, and collaboration. Our tutors are not just mentors; they&rsquo;re also partners in learning. Whether a student is struggling with a difficult concept or needs motivation to reach their full potential, our team is here to support them every step of the way. Choose JDN Tuition and experience the difference of studying in a nurturing and empowering environment.
              </p>
            </div>
          </div>
        </div>
